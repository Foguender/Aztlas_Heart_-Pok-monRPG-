...
with col1:
    # URL base da pasta raw do seu repositório no GitHub
    github_base_url = "https://raw.githubusercontent.com/seu_usuario/seu_repositorio/main/sprites"
    
    # poke_geral[0] pega o 'ID' do Pokémon retornado do seu banco de dados
