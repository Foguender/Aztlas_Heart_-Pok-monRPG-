...
* Normalmente dura 5 rodadas. A não ser que o pokémon que criou esse clima esteja segurando uma "Heat Rock"
* Ataques de fogo ganham vantagem na rolagem de dano; Ataques de Água ganham desvantagem na rolagem de dano;
* "Solar Beam" e "Solar Blade" perdem o turno de carga;
* O move Weather Ball muda seu tipo para Fogo e dobra o seu poder;
* "Morning Sun" "Synthesis" e "Moonlight" recuperam 2/3 do HP máximo;
* "Thunder" e "Hurricane" tem desvantagem na rolagem de Ataque;
* Previne Pokémon de serem Congelados;
* Pokémon com "Harvest" têm 100% de chance de recuperar a berry consumida;
* Ativa as habilidades: "Clorophyll", "Forecast", "Dry Skin", "Leaf Guard", "Solar Power" e "Flower Gift".

### **Chuva (Rain):**
* Normalmente dura 5 rodadas. A não ser que o pokémon que criou esse clima esteja segurando uma "Damp Rock"
* Ataques de Água ganham vantagem na rolagem de dano; Ataques de Fogo ganham desvantagem na rolagem de dano.
* Os moves "Solar Beam" e "Solar Blade" têm desvantagem na Rolagem de Dano;
* Muda o tipo do move Weather Ball para Água e dobra o seu poder;
* "Morning Sun" "Synthesis" e "Moonlight" recuperam 1/4 do HP máximo;
* "Thunder" e "Hurricane" ganham vantagem na Rolagem de Ataque;
* Ativa as habilidades: "Swift Swim", "Forecast", "Dry Skin", "Rain Dish" e "Hydration".

### **Granizo (Hail):**
* Normalmente dura 5 rodadas. A não ser que o pokémon que criou esse clima esteja segurando uma "Icy Rock"
* No início do turno de uma criatura, ela sofre um dano de tipo Gelo equivalente ao nível da criatura que criou esse clima, exceto os que possuem o tipo Ice (Gelo) e que tenham as habilidades Ice Body, Snow Cloak, Magic Guard e Overcoat;
* Os moves "Solar Beam" e "Solar Blade" têm desvantagem na Rolagem de Dano;
* Muda o tipo do move Weather Ball para Gelo e dobra o seu poder;
* "Morning Sun" "Synthesis" e "Moonlight" recuperam 1/4 do HP máximo;
* "Blizzard" ganha vantagem na Rolagem de Ataque;
* Permite o uso do move "Aurora Veil" que pode continuar em campo mesmo após o granizo se dissipar;
* Ativa as habilidades: "Slush Rush", "Forecast", "Ice Body" e "Snow Cloak".

### **Tempestade de Areia (Sansdstorm):**
* Normalmente dura 5 rodadas. A não ser que o pokémon que criou esse clima esteja segurando uma "Smooth Rock"
* No início do turno de uma criatura, ela sofre um dano de tipo Pedra equivalente ao nível da criatura que criou esse clima, exceto os que possuem os tipos Rock (Pedra), Ground (Terrestre) ou Steel (Aço), e que tenham as habilidades Sand Force, Sand Rush, Sand Veil, Magic Guard e Overcoat;
* Os moves "Solar Beam" e "Solar Blade" têm desvantagem na Rolagem de Dano;
* Muda o tipo do move Weather Ball para Pedra e dobra o seu poder;
* "Morning Sun" "Synthesis" e "Moonlight" recuperam 1/4 do HP máximo;
* Faz com que o move "Shore Up" recupere 2/3 da vida do usuário;
* Ativa as habilidades: "Sand Force", "Sand Veil" e "Sand Rush".

### **Neblina (Fog):**
* Todos os Pokémon, que estão em contato direto com a Neblina, tem desvantagem na Rolagem de Ataque;
* Dobra o poder da Weather Ball;
* Faz com que Mel não possa ser usado para atrair Pokémon;
* "Morning Sun" "Synthesis" e "Moonlight" recuperam 1/4 do HP máximo.
...
### - Condições causadas por Moves -

* **Semeado (Seeded):** Efeito do Move "Leech Seed" - O pokémon alvo desse move, recebe 1d4 de dano de Planta no final de cada turno. Metade desse dano (arredondado para cima) é restaurado para o pokémon usuário desse ataque, ou quaisquer pokémon subsequente usado pelo treinador, enquanto o pokémon que sofreu estiver em campo.

* **Amaldiçoado (Cursed):** Efeito do Move "Curse" (quando utilizado por um pokémon de tipo Fantasma) - Recebe 1d6 de dano Fantasma ao final da cada turno por 1 minuto.

* **Sonolento (Sleepy):** Efeito do move "Yawn" - Após receber essa condição, se você ainda estiver em campo no final do próximo turno, você adormece.

### - Condições de Status (Não Voláteis) -

* **Envenenado:** Tipos Aço e Venenoso são imunes. O Pokémon envenenado recebe uma quantia de dano igual ao seu bônus de proficiência.

* **Gravemente Envenenado:** Tipos Aço e Venenoso são imunes. O Pokémon envenenado recebe uma quantia de dano igual ao seu bônus de proficiência, a cada turno o multiplicador do bônus de Prof. aumenta em +1. O Pokémon que recebeu essa condição também terá desvantagem em rolagens de Ataque e Habilidades.

* **Congelado:** Tipos Gelo são imunes. Incapacitado e Impedido. A criatura congelada faz um teste de FOR no final de cada um dos turnos para se libertar. A CD é (10 + bônus de Prof. da criatura que causou o congelamento). Fora de combate a condição dura 1h. O status de Congelado acaba se a criatura congelada for atacada por algum Move que a deixe Queimada (sem deixar queimada).

* **Queimado:** Tipos Fogo são imunes. O Pokémon Queimado recebe uma quantia de dano igual ao seu bônus de proficiência. A criatura também tem desvantagem na rolagem de Ataque de Moves físicos.

* **Paralisado:** Tipos Elétricos são imunes. Desvantagem em qualquer teste de resistência de FOR ou DES. O Pokémon tem sua velocidade de deslocamento reduzida pela metade. No início do turno da criatura paralisada, role 1d4. Se o resultado for 1 o Pokémon ficará Incapacitado e Impedido, e perde sua ação e sua ação bônus para o treinador.
